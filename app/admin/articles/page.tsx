...
import { Article, CategorySlug, FaqItem } from '@/types';
import { calculateReadingTime, slugify } from '@/lib/utils';
import { useToast } from '@/components/ui/Toast';
import { Save, Plus, FileText, Sparkles, Check, ChevronRight } from 'lucide-react';
...
export default function AdminArticlesPage() {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    showToast('에디토리얼 기사가 라이브 사이트에 성공적으로 발행되었습니다!');
  };
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-[#6E6E6E]">
              CAT NOTE 에디터 전용 원스톱 콘텐츠 작성 및 AI SEO 최적화 도구
            </p>
          </div>
          ...
          <div className="lg:col-span-4 p-5 rounded-3xl bg-white dark:bg-[#1D231E] border border-[#ECECEC] dark:border-[#2A332C] space-y-3 shadow-xs">
            ...
            <div className="space-y-2 max-h-[70vh] overflow-y-auto pr-1">
              {articles.map((art) => (
                ...
                >
                  <div className="text-[10px] opacity-80 mb-1">{art.categoryName}</div>
